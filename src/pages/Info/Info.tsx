...
const Info = () => {
  ...
  return (
    <div className={styles.Info}>
      ...
      <h2>App component</h2>
      <span className={styles.ReactEmbedGist}>
        <ReactEmbedGist gist="mungadunga/d236ff022c96484bb217bf76b20a4144" />
      </span>
      ...
      <h2>Ebooks page</h2>
      <span className={styles.ReactEmbedGist}>
        <ReactEmbedGist gist="mungadunga/189a0969d512b35f2fa4c7abdbb76d8a" />
      </span>
