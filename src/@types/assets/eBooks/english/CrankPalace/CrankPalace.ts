...
import CrankPalace_Kindle from "./CrankPalace_Kindle.mobi";
import CrankPalace_EPUB from "./CrankPalace_EPUB.epub";
...
const CrankPalace = {
   ...
   downloadKindle: CrankPalace_Kindle,
   downloadEPUB: CrankPalace_EPUB,
}
