...
import TheDeathCure_EPUB from "./TheDeathCure_EPUB.epub";
...
const TheDeathCure = {
   ...
   language: "english",
   description: "Thomas escapes from having his memories restored in WICKED's headquarters and becomes entangled in the conflict between WICKED and the Right Arm – a rebel organization that opposes it.",
   ...
   downloadEPUB: TheDeathCure_EPUB,
}
